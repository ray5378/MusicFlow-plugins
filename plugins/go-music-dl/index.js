...
//  v1.5.0 — 新增 sortOrder 首页排序、合并 recommendPlaylist 插件
//  修复：CI 自动发版 workflow SIGPIPE 问题
// ----------------------------------------------------------------------------
...
globalThis.__mfPlugin = { manifest: {
    ...
    downloadUrl: "https://github.com/ray5378/MusicFlow-plugins/releases/download/go-music-dl-v1.5.0/go-music-dl.tar.gz",
    configSchema: [
